# 01 — Swedish homepage and shared public UI

Repository: redrider81/forsa
Branch: main
Commit: 088ffd03c531b59dc2772714249af8fa87a50654

Swedish homepage, root layout, and the shared header/footer/CTA and brand components. Shared content components are in 01a; the navigation component is split across 01b and 01c.
...
## Swedish public image references and alt text

The Swedish homepage references no photographic imagery. Images reachable on Swedish
public routes at HEAD:
...
| `/carolina-von-braun.png` | `src/components/ui/kinetic-team-hybrid.tsx` (see 01a) | `Carolina von Braun, coach och grundare av CVB Coaching` |

The two Swedish coaching path cards carry no image at HEAD.
