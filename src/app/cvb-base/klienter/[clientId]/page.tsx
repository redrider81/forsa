  ...
  return (
    <div className={portalPageStackClass}>
      ...
      {upcomingSession ? (
        <Panel>
          ...
          <div className="mt-5 flex flex-col gap-2.5 sm:flex-row">
            <AiActionLink href={`/cvb-base/klienter/${client.id}/forbered`} className="flex-1">
              Förbered session
            </AiActionLink>
            <Link
              href={`/cvb-base/klienter/${client.id}/sessioner/${upcomingSession.id}`}
          ...
          {dossier.sessions.length === 0 ? (
            ...
            [...dossier.sessions].reverse().map((item, index) => (
              <div key={item.id}>
                ...
                <RowLink
                  href={`/cvb-base/klienter/${client.id}/sessioner/${item.id}`}
      ...
      <Panel>
        ...
        <div className="mt-5 flex flex-col gap-2.5 sm:flex-row">
          <Link
            href={`/cvb-base/klienter/${client.id}/utveckling`}
            className={`flex-1 ${portalOutlineButtonClass} min-h-11 px-6 py-3 text-sm`}
          >
            Utvecklingsöversikt
          </Link>
          <Link
            href={`/cvb-base/klienter/${client.id}/klientvy`}
            className={`flex-1 ${portalOutlineButtonClass} min-h-11 px-6 py-3 text-sm`}
          >
            Visa som klient
          </Link>
