...
export const metadata: Metadata = {
  title: "Leadership Team Coaching | Forsa",
  description:
    "Forsa supports leadership teams that need clearer priorities, stronger decision quality, and decisions that hold in execution.",
};
