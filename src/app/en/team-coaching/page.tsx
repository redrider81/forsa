...
const focusList = [
  "The team's shared purpose in day-to-day work.",
...
const outcomes = [
  "An explicit accountability in the team's collaboration.",
  "Feedback given in time and received.",
  "A way of working the team can repeat without support.",
];
      ...
      <div className="mx-auto max-w-6xl px-6 pb-24 pt-12 md:px-10 md:pt-16">
        <section className="relative overflow-hidden border-b border-zinc-300 pb-16 md:pb-20">
          <HeroReveal>
            ...
            <h1 data-hero-headline className="mt-6 max-w-4xl text-4xl font-medium leading-tight tracking-tight md:text-6xl">
              From a group to a team with shared accountability.
            </h1>
            <p data-hero-body className="mt-8 max-w-3xl text-lg leading-8 text-zinc-700">
              For teams, project groups and specialist groups where demands are high but the way of
              working is unspoken.
            </p>
          </HeroReveal>
        </section>
        ...
        <section className="border-b border-zinc-300 py-16 md:py-20">
          <h2 className="text-3xl font-medium tracking-tight">
            Four situations where team coaching is relevant
          </h2>
        ...
        <section className="border-b border-zinc-300 py-16 md:py-20">
          <ScrollReveal variant="splitColumn" className="grid gap-10 md:grid-cols-12">
            <h2 data-col-left className="text-3xl font-medium leading-tight tracking-tight md:col-span-5">
              The difference from executive team coaching
            </h2>
            <div data-col-right className="space-y-6 text-lg leading-8 text-zinc-700 md:col-span-7">
              <p>
                Executive team coaching is about leadership decisions, mandate and direction in the
                organisation.
              </p>
              <p>
                Team coaching is about the team&apos;s collaboration, accountability and shared ways
                of working in operational work.
              </p>
            </div>
          </ScrollReveal>
        </section>
        ...
        <section className="py-16 md:py-20">
          <ScrollReveal variant="fadeUp">
            ...
            <p className="mt-6 max-w-3xl text-lg leading-8 text-zinc-700">
              Briefly describe the team&apos;s current situation and what needs to work better.
            </p>
