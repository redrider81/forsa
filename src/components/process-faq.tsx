...
const variantStyles = {
  default: {
    heading: "text-2xl font-medium leading-[1.28] tracking-tight md:text-[1.75rem]",
  ...
  editorial: {
    heading:
      "max-w-3xl font-serif text-[clamp(2.25rem,4vw,3.5rem)] font-medium leading-[1.18] tracking-[-0.035em] text-zinc-900",
    ...
    question:
      "flex w-full items-baseline justify-between gap-10 py-8 text-left font-serif text-[1.375rem] font-medium leading-[1.35] tracking-[-0.02em] text-zinc-900 transition-colors hover:text-[#7d6435] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-900 focus-visible:ring-offset-4 focus-visible:ring-offset-white md:py-10 md:text-[1.75rem] md:leading-[1.32]",
    answer:
